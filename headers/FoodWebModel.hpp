...
namespace FoodWebModel {
	...
	protected:
		...
		/*Class methods*/
	private:
		physicalType localePhotoPeriod,localeLightAtDepth, depthInMeters, turbidity_at_depth, light_at_top, resource_limitation_exponent, light_difference, sigmoid_light_difference;
