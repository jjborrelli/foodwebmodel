...
static const unsigned int HOURS_PER_DAY = 24, DAYS_PER_YEAR=365, HOURS_PER_HALF_DAY=HOURS_PER_DAY/2;
...
static const unsigned int MAX_CLASS_INDEX=3;
...
static const physicalType TRACED_COHORT_DEPTH=20.0f;
